...
class Receptionist: public Warehouse
{
    ...
    void login_check_receptionist()
    {
        ...
        while (loginAttempt<5)
        {
            ...
            {
                getc=getch();
                if((getc>='a'&&getc<='z')||(getc>='A'&&getc<='Z')||(getc>='0'&&getc<='9'))
                 {
                    password[i]=getc;//stores a in pass
                    ++i;
                    cout<<"*";
                 } 
                 if(getc=='\r')//if enter is pressed
                    {
            ...
            if(username=='a' && pass.compare(password))
            {   
                cout<<"\n\t\t*******Welcome Prathamesh!*******\n";
                break;
            }
            else if(username == 'b' && pass.compare(password))
            {   
                cout<<"\n\t\t*****Welcome Onkar!******\n";
                break;
            }
        ...
        {   cout<<"\n\t\tPlease enter your user name: \t";
            ...
            for(int i=0;;)
            {
                ...
                if((gc>='a'&&gc<='z')||(gc>='A'&&gc<='Z')||(gc>='0'&&gc<='9'))
                 {
                    password[i]=gc;//stores a in pass
                    ++i;
                    cout<<"*";
                 } 
                 if(gc=='\r')//if enter is pressed
                    {
                         password[i]='\0';//null means end of string.
                         break;//break the loop
                    }
            ...
            if(username=='a' && passcode.compare(password))
            {   
                cout<<"\n\t\t*******Welcome Prathamesh!*******\n";
                break;
            }
            else if(username == 'b' && passcode.compare(password))
            {   
                cout<<"\n\t\t*****Welcome Onkar!******\n";
                break;
            }
